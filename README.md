...
Para executar o projeto, é necessário ter instalado o nodeJS, que por sua vez possibilitará instar o json-server necessário para execução e opcionalmente o browser-sync.
